	...
	<section class="o-section c-section--main-page pt-0">
		...
		<div class="c-about u-flex u-flex--column">
			...
			<div class="c-about__video-content bg-white border-radius">
				<div class="o-section__wrapper">
					<div class="c-about__video u-flex gap-md">
						<div class="u-flex flex-1">
							<div class="video-wrapper w-100 w-100 video-explain items-center u-flex">
								<video class="video-explain-personal" id="myVideo"
									   poster="https://plus.barghapp.com/wp-content/uploads/2025/12/cover-video-plus-o-e1767084409806.webp">
									<source
										src="<?php echo get_template_directory_uri(); ?>/assets/videos/video-plus.mp4"
										type="video/mp4">
						...
						<div class="u-flex flex-1" id="personal-pointer">
							<video
								autoplay
								loop
								muted
								...
								<source src="<?php echo get_template_directory_uri(); ?>/assets/videos/about.mp4"
										type="video/mp4" class="w-100 video-personal">
							</video>
						</div>
					</div>
				</div>
				...
				<span class="u-flex items-center">
					...
					<img data-lazyloaded="1"
						...
						<div class="c-about__desc">
							...
							<p class="txt-justify m-0">
								سامانه برق‌آپ، به‌عنوان اولین سامانه جامع آنلاین خرید برق در کشور، با داشتن مجوز
								دانش‌بنیان
								و
								همکاری با معتبرترین شرکت‌های خرده‌فروش برق در ایران، جایگاه ویژه‌ای در بازار برق دارد.
								این
								سامانه از طریق همکاری با بزرگ‌ترین نیروگاه‌های برق کشور و تأمین‌کننده‌های برق معتبر، سهم
								گسترده‌ای از بازار را در اختیار دارد و تنوع بالای مشترکین آن، آن را به یکی از معتبرترین
								بازیگران
								صنعت برق تبدیل کرده است. همچنین عضویت در انجمن ساتکا اعتبار آن را بیش از پیش افزایش داده
								است.
							</p>
							<ul>
								<li>
									اولین سامانه جامع آنلاین خرید برق در کشور
								</li>
