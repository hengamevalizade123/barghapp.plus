<section class="o-section c-section--main-page p-0">
	<div class="o-section__wrapper p-0">
		<div class="c-price-list-content u-flex gap-md">
										...
										<div class="c-page__table js-tabs">
											<table>
												<tr>
													...
													<th class="u-flex items-center color-text low">
														<div class="c-price__live-bolb"></div>
														<span>
															کم بار</span>
														</th>
													<th class="u-flex items-center color-text middle">
														<div class="c-price__live-bolb"></div>
														<span>
															میان بار
														</span>
														</th>
													<th class="u-flex items-center color-text high">
														<div class="c-price__live-bolb"></div>
													<span>
													اوج بار
													</span>
